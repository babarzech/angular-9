  ...
  function k() {
    ...
    for (; h < g; h++)
      if (null != (a = arguments[h]))
        for (b in a) c = f[b], e = a[b], f !== e && (l && e &&
          (m(e) || (d = Array.isArray(e))) ? (d ? (d = !1, c = c && Array.isArray(c) ? c : []) : c = c && m(c) ? c : {}, f[b] = k(l, c, e)) : void 0 !== e && (f[b] = e));
    return f
  }
  ...
  if (!window.TradingView) {
    var n = {
      ...
      d = {
        ...
        widget: function (a) {
          ...
          a.preset && (a = a.preset, n[a] ? (a = n[a], this.options.disabledFeatures = 0 < this.options.disabledFeatures.length ? this.options.disabledFeatures.concat(a.disabledFeatures) : a.disabledFeatures, this.options.enabledFeatures = 0 < this.options.enabledFeatures.length ? this.options.enabledFeatures.concat(a.enabledFeatures) : a.enabledFeatures) : console.warn("Unknown preset: `" + a + "`"));
    ...
    d.widget.prototype = {
      ...
      _autoResizeChart: function () {
        this.options.fullscreen && (d.gEl(this.id).style.height = window.innerHeight + "px")
      },
      create: function () {
        var a = this.render(),
          b = this,
      ...
      unsubscribe: function (a, b) {
        this._innerWindow().tradingViewApi.unsubscribe(a,
          b)
      },
