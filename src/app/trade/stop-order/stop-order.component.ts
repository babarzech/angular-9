...
export class StopOrderComponent implements OnInit {
  ...
  // @ViewChild(TradeComponent) Trade: TradeComponent;
  ...
  //   let dollarPrice = 0;
  //   if (this.mainPair.baseCurrency.symbol === 'USDT') {
  //     dollarPrice = this.model[ordrType][inputType];
  //   } else {
  //     if (this.myPairs.getPairByName(this.mainPair.baseCurrency.symbol + '/USDT')) {
  //       dollarPrice = this.myPairs.getPairByName(this.mainPair.baseCurrency.symbol + '/USDT').rateUsd * this.model[ordrType][inputType];
  //     } else {
  //       dollarPrice = 0;
  //     }
  //   }
